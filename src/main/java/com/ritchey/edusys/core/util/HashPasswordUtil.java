...
public class HashPasswordUtil {
    ...
    public static String createHashPwd(String password) throws NoSuchAlgorithmException, InvalidKeySpecException{
        return createHashPwd(password.toCharArray());
    }


    public static String createHashPwd(char[] password) throws NoSuchAlgorithmException, InvalidKeySpecException{
